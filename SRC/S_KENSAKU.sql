...
/****** Object:  StoredProcedure [dbo].[S_KENSAKU]    Script Date: 2015/10/10 7:57:36 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE  PROCEDURE [dbo].[S_KENSAKU]
	@P1 as int 
	,@P2 as int
AS
BEGIN
...
END
	...
	BEGIN
		...
		SET @WK_SQL = 'SELECT * From dbo.Identify_Entity_tbl Where [識別ID] = ' + cast(@P1 as nvarchar(50)) + ' ORDER BY [識別ID] , [F_ID]'
